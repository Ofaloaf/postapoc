...
NTechnology = {
	...
	BASE_DEMESNE_SPREAD_BONUS = 0.02, 			-- bonus for each other province in demesne with the tech
	...
	START_MIL_CATHOLIC  = 1.5,
	START_ECO_CATHOLIC  = 1.5,
	START_CUL_CATHOLIC  = 1.5,
	END_MIL_CATHOLIC    = 2.5,
	END_ECO_CATHOLIC    = 2.5,
	END_CUL_CATHOLIC    = 2.5,
	END_REN_CLOSE       = 2.5, -- Tech level at the center of the renaissance
	END_REN_FAR         = 3.0, -- Tech level on the fringe of the renaissance
	REN_PROVINCE        = 1124, -- Province where the Renaissance is centered
	...
	END_MIL_BYZANTIUM   = 2.5,
	END_ECO_BYZANTIUM   = 2.5,
	END_CUL_BYZANTIUM   = 2.5
},  
...
NAI =
{
	...
	MARRIAGE_AI_PRESTIGE_VALUE = 0.66,						-- Multiplier for how highly AI values prestige when arranging marriages and evaluating marriage offers
