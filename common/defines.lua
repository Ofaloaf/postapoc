...
NDiplomacy = {
	...
	MAX_DIPLO_DISTANCE_SAME_CULTURE_GROUP = 150, -- Bonus to max diplo distance for being of the same culture group
...
NTechnology = {
	...
	END_MIL_CATHOLIC    = 2.0,
	END_ECO_CATHOLIC    = 2.0,
	END_CUL_CATHOLIC    = 2.0,
